CREATE TABLE "mail0_message_embeddings" (
...
CREATE TABLE "mail0_thread_embeddings" (
	"id" text PRIMARY KEY NOT NULL,
	"embedding" jsonb NOT NULL,
	"metadata" jsonb NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
...
CREATE INDEX "message_embeddings_connection_idx" ON "mail0_message_embeddings" USING btree ("metadata");--> statement-breakpoint
CREATE INDEX "message_embeddings_thread_idx" ON "mail0_message_embeddings" USING btree ("metadata");--> statement-breakpoint
CREATE INDEX "message_embeddings_created_at_idx" ON "mail0_message_embeddings" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "thread_embeddings_connection_idx" ON "mail0_thread_embeddings" USING btree ("metadata");--> statement-breakpoint
CREATE INDEX "thread_embeddings_thread_idx" ON "mail0_thread_embeddings" USING btree ("metadata");--> statement-breakpoint
CREATE INDEX "thread_embeddings_created_at_idx" ON "mail0_thread_embeddings" USING btree ("created_at");--> statement-breakpoint
